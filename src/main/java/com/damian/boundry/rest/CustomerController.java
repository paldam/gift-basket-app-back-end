...
public class CustomerController {
    ...
    public ResponseEntity<List<CustomerAddressDTO>> getCustomersWithAddr() {
    ...
    public ResponseEntity<Company> mergeCompanies(@RequestPart(value = "companies") List<Company> companies,
