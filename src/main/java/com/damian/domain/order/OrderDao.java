...
public interface OrderDao extends JpaRepository<Order, Long>, JpaSpecificationExecutor<Order> {
    ...
    @Query(value = "SELECT o FROM Order o LEFT JOIN FETCH o.productionUser pu LEFT JOIN FETCH o.address ad LEFT JOIN FETCH o.customer c LEFT JOIN FETCH c.company cp LEFT JOIN FETCH o.deliveryType dt LEFT JOIN FETCH o.orderStatus os LEFT JOIN FETCH o.orderItems oi LEFT JOIN FETCH oi.basket ba left join fetch ba.basketSezon bs  WHERE o.orderId = ?1")
